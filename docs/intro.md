...
The full documentation is available at the [cheby ReadTheDocs page](https://cheby.readthedocs.io/en/latest/).
Jupyter notebooks in the `examples` folder provide examples of usage.
